	...
	<div id="content">
		...
		<div class="leftContent">
			...
			<%
				...
				if(enquiryList==null){                			
											enquiryList=null;
											List<List<String>>todayFollowUp=registrationController.getTrainningRegistationAllFollowUp(request);
				...
				<%
					int count =0;
															for(String registrationId:alist){
																count++;
																TrainingRegistrationDTO dto=registrationController.getRegistration(registrationId);
