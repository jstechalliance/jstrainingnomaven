...
<%
	...
	WebEnquiryDTO dto=new WebEnquiryController().getWebEnquiryById(request.getParameter("web_enq_id"),request);
	List <Course>allCourseList=courseService.getAllCourse((String)request.getSession(false).getAttribute("BRANCHID"));
        	...
        	String mymymessage=(String)request.getAttribute("WEBENQUIRYREQUEST");
        	if(mymymessage!=null){
        		out.print("<input type='hidden' value='"+mymymessage+"' id='mymymessage'/>");
%>
<script>
	ShowErrorMessageDialog("Enquiry Message",document.getElementById("mymymessage").value);
	</script>
<%} %>
...
// 							}
					...
					<form action="#" id="savenewenquiryForm">
						<div class="rightContent">
							...
							<input type="hidden" name="web_enq_id" value="<%=dto.getId() %>"/>
...
<!-- 											<option value="Live Project">Live Project</option> -->
							...
							<div id="training_enquiry_div">
								<table width="100%" align="right" border="1">
									<tr>
										...
										<td width="60%"><input type="hidden"
											...
											id="id_training_enquiry_enquiry_id" size="20" /> <input  value="<%=dto.getName() %>"
									...
									<tr>
										...
										<td width="60%"><input type="text"  style="width: 160px;"  value="<%=dto.getContactno() %>"
											name="training_enquiry_contact_no"
											id="id_training_enquiry_contact_no" size="21" /></td>
									</tr>
									<tr>
										<td width="40%" align="right">Email-Id :</td>
										<td width="60%"><input type="text" style="width: 160px;"  value="<%=dto.getEmail() %>"
								...
								<table width="100%" border="1" align="right">
									<% 
									String reference_name="Not Applicable";
										if(!dto.getReferance().equalsIgnoreCase("")){
											reference_name=dto.getReferance();
										}
									%>
									<tr>
										<td width="40%" align="right">Full Name :</td>
