...
<script src="../js/myalert/jquery.ui.draggable.js"
	type="text/javascript"></script>
<script src="../js/myalert/jquery.alerts.js" type="text/javascript"></script>
<link href="../js/myalert/jquery.alerts.css" rel="stylesheet"
		...
		<table width="600" border="2" align="center" bordercolor="#000000">
			<tr>
				<td height="451" align="center" valign="top"><table
						...
						<tr>
							<td colspan="2"><img src="../images/line.PNG" width="600"
								height="4"></td>
						</tr>
					</table>
					...
					<table width="100%" border="0">
						<tr>
							<td width="100%" align="center"><img
								src="../images/android.png" width="62px" height="50px"
								border="0"> <img src="../images/iphone.png" width="62px"
								height="50px" border="0"> <img src="../images/java.png"
								width="62px" height="50px" border="0"> <img
								src="../images/mysql.png" width="62px" height="50px" border="0">
								<img src="../images/se.png" width="62px" height="50px"
								border="0"></td>
						</tr>
						<tr>
