...
public class FacebookController {
	...
	public ConnectionRepository getUserConnectionRepository() {
		return userConnectionRepository;
	}



	public void setUserConnectionRepository(
	...
	public FbConnectionHelper getFbConnectionHelper() {
		return fbConnectionHelper;
	}



	public void setFbConnectionHelper(FbConnectionHelper fbConnectionHelper) {
		this.fbConnectionHelper = fbConnectionHelper;
	}



	public FbOperationsHelper getFbOperationsHelper() {
		return fbOperationsHelper;
	}



	public void setFbOperationsHelper(FbOperationsHelper fbOperationsHelper) {
		this.fbOperationsHelper = fbOperationsHelper;
	}
