...
public class StringUtil {
	 ...
	 * </li>
	 * <li><b>LevensteinDistance</b> - the number of changes needed to change
	 ...
	 * That is to say that a <code>null</code> input will return
	 * <code>null</code>. Where a <code>boolean</code> or <code>int</code> is
	 ...
	 * symbol <code>*</code> is used to indicate any input including
	 * <code>null</code>.
	 * </p>
	 * 
	 ...
	 *      Whitespace: // Character.isWhitespace() is faster than
	 *      WHITESPACE.indexOf() // where WHITESPACE is a string of all
	 *      whitespace characters // // Character access: // String.charAt(n)
	 *      versus toCharArray(), then array[n] // String.charAt(n) is about 15%
	 *      worse for a 10K string // They are about equal for a length 50
	 *      string // String.charAt(n) is about 4 times better for a length 3
	 *      string // String.charAt(n) is best bet overall // // Append: //
	 *      String.concat about twice as fast as StringBuffer.append // (not
	 *      sure who tested this)
	 * 
...
//	private static final int PAD_LIMIT = 8192;
	...
	public static boolean isNotEmptyWithTrim(Object str) {
		if(str==null || !(str instanceof String)) return false;
		return !StringUtil.isEmptyWithTrim(""+str);
	}
	/**
	 * <p>
	...
	public static String replaceEachRepeatedly(String text,
		...
		// timeToLive should be 0 if not used or nothing to replace, else
		// it's
	...
	private static String replaceEach(String text, String[] searchList,
		...
		// have to double if it goes over a bit
		int increase = 0;
